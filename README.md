...
完整程式碼：
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1tWrl8xKp3cZvn7Sy9-RwPG7OYr9xT3d1?usp=sharing)
...
## 📂 檔案結構
* `analysis.ipynb`: 包含所有資料處理邏輯與圖表生成的程式碼。
